...
public class AssinaPdf extends CreateSignatureBase {
    ...
    public void assina() throws Exception {
        ...
        KeyStore keyStore = getKeystore(assinaturaModel.getCertificado());
     ...
     * @throws Exception
     */
    private KeyStore getKeystore(Certificado certificado) throws Exception {

        if (!certificado.isValido()) {
            throw new Exception("Certificado inválido");
        }

        return CertificadoService.getKeyStore(certificado);
